\begin{figure}[htb]
    \centering
    \includesvg[inkscapelatex=false,width=1\columnwidth]{images/fleetInfo/gen_age.svg}
    \includesvg[inkscapelatex=false,width=1\columnwidth]{images/fleetInfo/gen_ageAtRetirement.svg}
...
\begin{figure}[htb]
    \centering
    \includesvg[inkscapelatex=false,width=\linewidth]{images/heatmap_large.svg}  
...
\begin{figure}[htb]
    ...
    \begin{minipage}{0.95\textwidth}
        \includesvg[inkscapelatex=false,width=1\columnwidth]{images/distribution-cracking.svg}
    ...
    \begin{minipage}{0.95\textwidth}
        \includesvg[inkscapelatex=false,width=1\columnwidth]{images/distribution-minimized.svg}
...
\begin{figure}[htb]
    ...
    \begin{minipage}{0.5\textwidth}
        \includesvg[inkscapelatex=false,width=\linewidth]{images/group3_path.svg}  
        \subcaption{\textbf{Group 3} - Distance to Sink Nodes}
    \end{minipage}%
    \begin{minipage}{0.5\textwidth}
        \includesvg[inkscapelatex=false,width=\linewidth]{images/group4_path.svg}  
        \subcaption{\textbf{Group 4} - Distance to Sink Nodes}
    \end{minipage}

    \begin{minipage}{0.25\textwidth}
        \includesvg[inkscapelatex=false,width=\linewidth]{images/group3_averageCashflow.svg}  
        \subcaption{Average Cashflows}
    \end{minipage}%
    \begin{minipage}{0.25\textwidth}
        \includesvg[inkscapelatex=false,width=\linewidth]{images/group3_PM2.5.svg}  
        \subcaption{PM 2.5 Emissions}
    \end{minipage}%
    \begin{minipage}{0.25\textwidth}
        \includesvg[inkscapelatex=false,width=\linewidth]{images/group4_ownership.svg}  
        \subcaption{Municipal Ownership}
    \end{minipage}%
    \begin{minipage}{0.25\textwidth}
        \includesvg[inkscapelatex=false,width=\linewidth]{images/group4_proCoal.svg}  
