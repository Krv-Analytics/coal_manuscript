...
\begin{figure}[H]
    \includesvg[inkscapelatex=false,width=\linewidth]{figs/svgs/heatmap_small.svg}  
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.32\textwidth}
        \includesvg[inkscapelatex=false,width=\linewidth]{figs/svgs/group3_percCapMax.svg}  
        \subcaption{Node colors represent the maximum percentage of retiring coal capacity at a plant within the node.}
    \end{minipage}%
    \hfill
    \begin{minipage}{0.32\textwidth}
        \includesvg[inkscapelatex=false,width=\linewidth]{figs/svgs/group3-percCapAve.svg}  
        \subcaption{Colored by the average percentage of coal capacity retiring within each node.}
    \end{minipage}
    \hfill
    \begin{minipage}{0.32\textwidth}
        \includesvg[inkscapelatex=false,width=\linewidth]{figs/svgs/group3-subGraphs.svg}  
    ...
    \begin{minipage}{1\textwidth}
        \includesvg[inkscapelatex=false,width=\linewidth]{figs/svgs/group3-heatmap.svg}  
