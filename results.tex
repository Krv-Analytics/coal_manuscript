...
\begin{figure}[H]
    ...
    \begin{minipage}{0.32\textwidth}
        ...
        \subcaption{Average percentage of coal capacity retiring within each node.}
    \end{minipage}
    \hfill
    \begin{minipage}{0.32\textwidth}
    ...
    \highlight{How to interpret the models above:
        \begin{itemize}
    ...
    \begin{minipage}{1\textwidth}
        ...
        \subcaption{Classification of Group 3 Sub-Graph Retirement Archetypes (all plant with full planned retirements in sub-graphs)}
    \end{minipage}
